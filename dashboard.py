...
datapane login --token=0fb7c38271c2430b051a4fc3d15a07ef2268a852
...
data_main = pdr.get_data_yahoo(tickers_list, start=analysis_start_date, end=analysis_end_date_plusone) #switch this date for different cohorts
